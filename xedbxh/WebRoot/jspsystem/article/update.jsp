...
<html>
  ...
  loadresource();
     ...
     if(formcheck()){
            ...
            url: 'article/updateasfile', // 需要提交的 url
 ...
 $("#content").val(html);
  ...
  $.ajax({
           ...
           if(data){
            $("input[name='id']")[0].value=data.id;
             ...
             $("input[name='shortitle']")[0].value=data.shortitle;
              $("input[name='imgpath']")[0].value=data.imgpath;
         ...
         var arrse=$("#level").children();
         
         for(var i = 0;i<arrse.length;i++){
         if(arrse[i].value==data.level){
         arrse[i].selected="selected";
         }
  ...
  <body>
   ...
   <form id="myform"  enctype="multipart/form-data">
    ...
    <li><label>级别</label><select id="level" name="level" style="border: solid 1px #666666"><option selected="selected" value="0">普通</option><option value="1">推荐</option></select></li>
