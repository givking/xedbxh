...
<html>
  ...
  loadresource();
     ...
     if(formcheck()){
            ...
            url: 'product/updateasfile', // 需要提交的 url
  ...
  $.ajax({
           ...
           if(data){
            $("input[name='id']")[0].value=data.id;
             ...
             $("input[name='discription']")[0].value=data.discription;
             $("input[name='selmoney']")[0].value=data.selmoney;
             $("input[name='realmoney']")[0].value=data.realmoney;
         ...
         rads[i].checked="checked";
                ...
                var rads1 = $("input[name='state']");
         
             for(var i = 0;i<rads1.length;i++){
         if(rads1[i].value==data.state){
         rads1[i].checked="checked";
         }
