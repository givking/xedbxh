...
<html>
  ...
  $.ajax({
           ...
           $("input[name='email']")[0].value=data.email;
            $("textarea[name='content']")[0].value=data.content;
          if(data.bill=="on"){
...
<body>
   ...
   <form id="myform">
    ...
    <div class="formtitle"><span>留言详情</span></div>
    <input name="id" type="hidden"/>
    <ul class="forminfo">
    <li><label>姓名:</label><input name="name" type="text" class="dfinput" readonly="readonly"/></li>
    <li><label>联系电话:</label><input name="phone" type="text" class="dfinput" readonly="readonly"/></li>
    <li><label>邮箱:</label><input name="email" type="text" class="dfinput" readonly="readonly"/></li>
    <li><label>创建时间:</label><input name="createtime" type="text" class="dfinput" readonly="readonly"/></li>
    <li><label>留言:</label><textarea name="content" type="text" class="dfinput" style="height:200px" readonly="readonly"></textarea></li>   
