...
<html>
  ...
  $(document).ready(function(){
        ...
        if(formcheck()){
            ...
            url: 'menu/updateasfile', // 需要提交的 url
  ...
  $.ajax({
           ...
           if(data){
            $("input[name='id']")[0].value=data.id;
             $("input[name='create_time']")[0].value=data.create_time;
           ...
           $.get("menu/findbyid",{id:data.parent_id},function(data){
           if(data){
...
<body>
   ...
   <form id="myform"  enctype="multipart/form-data">
    ...
    <li><label>时间</label><input name="create_time" type="text" class="dfinput" /><i>必填</i></li>
