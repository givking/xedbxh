...
<table width="752" height="362" border="0" cellpadding="0" cellspacing="0" class="tb">
  ...
  <tr>
    ...
    <tr>
    <td height="129" class="left_td tbord">回复<input id="u_id" type="hidden" name = "u_id"/></td>
