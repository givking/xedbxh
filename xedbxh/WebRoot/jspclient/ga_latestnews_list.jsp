...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>jspclient/css/ga_latestnews_list.css" />
	...
	var obj = document.getElementById("yema");
	 ...
	 var flag = true;
	    ...
	    if(flag){   
	        window.location.href="<%=basePath%>webcenter/webarticlelistall?type=all&page="+obj.value;
	    }
	}
	</script>	
  ...
  <body>
  		...
  		<div id="content">
  			<div id="left">
  				<div id="left_top">
  				<!-- 大标题 -->
  					<span ><a style="color:#FFFFFF">最新消息</a>
					</span>
  				</div>
				<div id="left_foot">
					<!-- 小标题 -->
  			...
  			<div id="right">
  				<div id="right_top">
					...
					<div id="right_top_foot"><span>最新消息</span></div>
				</div>
				...
				<ul>
					<c:forEach items="${artlist}" var="art">
						<li>
							...
							<div id="r_list_foot">
								<span><c:if test="${fn:length(art.content)<=100}"></c:if>
								<c:if test="${fn:length(art.content)>100}"></c:if>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td width="60%" align="right">[ <a
									href="webcenter/webarticlelistall?type=all&page=1"
									class="right-font08">首页</a> | <a
									href="webcenter/webarticlelistall?type=all&page=${page.pagebefroe}"
									class="right-font08">上一页</a> | <a
									href="webcenter/webarticlelistall?type=all&page=${page.pageafter}"
									class="right-font08">下一页</a> | <a
									href="webcenter/webarticlelistall?type=all&page=${page.pagecount}"
