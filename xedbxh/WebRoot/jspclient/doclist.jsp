...
var obj = document.getElementById("yema");
 ...
 var flag = true;
    ...
    if(flag){
        ...
        window.location.href="<%=basePath%>webcenter/webtablelist?menu_id=${nav.id}&page="+obj.value;
    }
...
<div class="list_main">
  ...
  <div class="r_list">
     <ul>
     <c:forEach items="${tlist}" var="tb">
	  <li>
	   <span style=" width:600px; height:26px; line-height:22px; float:left; display:block"><a href="webcenter/downloaddoc?id=${tb.d_id}">${tb.title}</a></span>
	   <span style="line-height:26px; float:right; display:block">${tb.createtime}</span>
	   </li>
  </c:forEach>
  ...
  <table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="49%" align="right">
												[
												<a href="webcenter/webtablelist?menu_id=${nav.id}&page=1"
													class="right-font08">首页</a> |
												<a
													href="webcenter/webtablelist?menu_id=${nav.id}&page=${page.pagebefroe}"
													class="right-font08">上一页</a> |
												<a
													href="webcenter/webtablelist?menu_id=${nav.id}&page=${page.pageafter}"
													class="right-font08">下一页</a> |
												<a
													href="webcenter/webtablelist?menu_id=${nav.id}&page=${page.pagecount}"
