...
var obj = document.getElementById("yema");
 ...
 var flag = true;
    ...
    if(flag){
        ...
        window.location.href="<%=basePath%>webcenter/webmailasklist?menu_id=${nav.id}&page="+obj.value;
    }
    ...
    <table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="49%" align="right">
												[
												<a href="webcenter/webmailasklist?menu_id=${nav.id}&page=1"
													class="right-font08">首页</a> |
												<a
													href="webcenter/webmailasklist?menu_id=${nav.id}&page=${page.pagebefroe}"
													class="right-font08">上一页</a> |
												<a
													href="webcenter/webmailasklist?menu_id=${nav.id}&page=${page.pageafter}"
													class="right-font08">下一页</a> |
												<a
													href="webcenter/webmailasklist?menu_id=${nav.id}&page=${page.pagecount}"
