...
<div class="list_main">
  ...
  <!-- <div style=" width:1000px; height:60px"></div> -->
	...
	<div class="content_title">最近捐款</div>
	...
	<span style=" float:right; margin-left:20px;  display:block"><a href="webcenter/clienthome">关闭窗口</a></span>
	<span style=" float:right; margin-left:100px;  display:block"><a href="javascript:printpreview()">打印本页</a></span>
	...
	<ul>
	<li>捐赠人：${art.donor}</li>
	<li>捐赠金额：${art.amount}</li>
	<li>捐赠意向：${art.intention}</li>
	</ul>
	</div>
	<div style=" width:800x; height:20px"></div>
