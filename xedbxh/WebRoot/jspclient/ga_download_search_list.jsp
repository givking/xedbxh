...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>jspclient/css/ga_search_list.css" />
	...
	var obj = document.getElementById("yema");
	 ...
	 var flag = true;
	    ...
	    if(flag){   
	        window.location.href="<%=basePath%>webcenter/download_search?tit=${title}&page="+obj.value;
	    }
	}
	</script>	
  ...
  <body>
  		...
  		<div id="content">
  			<div id="left">
  				<div id="left_top">
  				<!-- 大标题 -->
  					<span ><a style="color:#FFFFFF">搜索</a>
					</span>
  				</div>
				<div id="left_foot">
					<!-- 小标题 -->
  			...
  			<div id="right">
  				<div id="right_top">
					...
					<div id="right_top_foot"><span>搜索</span></div>
				</div>
				
				<!-- 中间列表 -->
				<div class="r_list">
				<ul>
						<c:forEach items="${dowlist}" var="art">
						<li>
								<div id="r_list_top">
									<div id="r_list_top_left">
										<span><a style="color:rgb(0,0,0);font-size:13px;font-weight: 500;" href="javascript:downfile('${art.id}')">${art.filename}</a>
										</span>
									</div>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td width="60%" align="right">[ <a
									href="webcenter/download_search?tit=${title}&page=1"
									class="right-font08">首页</a> | <a
									href="webcenter/download_search?tit=${title}&page=${page.pagebefroe}"
									class="right-font08">上一页</a> | <a
									href="webcenter/download_search?tit=${title}&page=${page.pageafter}"
									class="right-font08">下一页</a> | <a
									href="webcenter/download_search?tit=${title}&page=${page.pagecount}"
