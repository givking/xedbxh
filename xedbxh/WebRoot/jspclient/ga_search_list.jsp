  ...
  <head>
	...
	var obj = document.getElementById("yema");
	 ...
	 var flag = true;
	    ...
	    if(flag){   
	        window.location.href="<%=basePath%>webcenter/article_search?tit=${title}&page="+obj.value;
	    }
	}
	</script>	
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td width="60%" align="right">[ <a
									href="webcenter/article_search?tit=${title}&page=1"
									class="right-font08">首页</a> | <a
									href="webcenter/article_search?tit=${title}&page=${page.pagebefroe}"
									class="right-font08">上一页</a> | <a
									href="webcenter/article_search?tit=${title}&page=${page.pageafter}"
									class="right-font08">下一页</a> | <a
									href="webcenter/article_search?tit=${title}&page=${page.pagecount}"
