...
<div class="list_main">
  ...
  <div class="r_list">
     ...
     <c:forEach items="${artlist}" var="art">
	  <li>
	   <span style=" width:600px; height:26px; line-height:16px; float:left; display:block"><a href="webcenter/webarticlecontent?id=${art.id}&&menu_id=${art.menu_id}">${art.title}</a></span>
