...
<div class="list_main">
  ...
  <div class="r_list">
     ...
     <c:forEach items="${artlist}" var="art">
	  <li>
	   <span style=" width:600px; height:26px; line-height:16px; float:left; display:block"><a href="webcenter/webdonationcontent?id=${art.id}">${art.donor}</a></span>
	   <span style="line-height:26px; float:right; display:block">${art.createtime}</span>
	   </li>
  </c:forEach>
  ...
  <table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="60%" align="right">
												[
												<a href="webcenter/webarticlelist?id=${nav.id}&page=1"
